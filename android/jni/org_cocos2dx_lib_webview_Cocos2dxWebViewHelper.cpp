...
JNIEXPORT jboolean JNICALL Java_org_cocos2dx_lib_webview_Cocos2dxWebViewHelper_shouldStartLoading(JNIEnv *env, jclass, jint index, jstring jurl) {
...
JNIEXPORT void JNICALL Java_org_cocos2dx_lib_webview_Cocos2dxWebViewHelper_didFinishLoading(JNIEnv *env, jclass, jint index, jstring jurl) {
    auto charUrl = env->GetStringUTFChars(jurl, NULL);
    std::string url = charUrl;
    env->ReleaseStringUTFChars(jurl, charUrl);
...
JNIEXPORT void JNICALL Java_org_cocos2dx_lib_webview_Cocos2dxWebViewHelper_didFailLoading(JNIEnv *env, jclass, jint index, jstring jurl) {
    auto charUrl = env->GetStringUTFChars(jurl, NULL);
    std::string url = charUrl;
    env->ReleaseStringUTFChars(jurl, charUrl);
...
JNIEXPORT void JNICALL Java_org_cocos2dx_lib_webview_Cocos2dxWebViewHelper_onJsCallback(JNIEnv *env, jclass, jint index, jstring jmessage) {
